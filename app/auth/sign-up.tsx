...
/**
 * Sign up – parity with companion-app /auth/sign-up (mobile).
 * Form (email, password), Google button, link to sign-in. TODO: backend auth.
 */
export default function SignUpScreen() {
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    try {
      // TODO: call registerApi when backend exists
  ...
  const handleGoogle = () => {
    ...
    setError('Google sign-up: TODO backend.');
  };
    ...
    <ThemedView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        ...
        <ThemedText style={styles.subtitle}>
          Sign up to reserve gifts and manage your trips.
        </ThemedText>
        ...
        <Pressable onPress={handleGoogle} disabled={loading} style={[styles.googleBtn, loading && styles.disabled]}>
